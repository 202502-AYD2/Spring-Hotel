      ...
      <div className="pt-24 pb-12 px-4">
        <div className="container mx-auto max-w-7xl">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-4xl font-serif font-bold mb-2">Gestión de Reservas</h1>
              <p className="text-muted-foreground">Administra todas las reservas del hotel</p>
            </div>
                ...
                <TableBody>
                  {filteredReservations.map((reservation) => (
                    <TableRow key={reservation.id}>
                      ...
                      <TableCell>
                        <div>
                          <p className="font-medium">{reservation.profiles?.name}</p>
                          <p className="text-xs text-muted-foreground">{reservation.profiles?.email}</p>
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell className="font-medium">${reservation.total_price.toLocaleString()}</TableCell>

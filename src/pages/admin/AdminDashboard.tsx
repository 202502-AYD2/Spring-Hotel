    ...
    <DashboardLayout>
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="shadow-elegant hover:shadow-gold transition-smooth cursor-pointer" onClick={() => navigate("/admin/rooms")}>
            <CardHeader><CardTitle>Gestionar Habitaciones</CardTitle></CardHeader>
            <CardContent>
          ...
          <Card className="shadow-elegant hover:shadow-gold transition-smooth cursor-pointer" onClick={() => navigate("/admin/reservations")}>
            <CardHeader><CardTitle>Gestionar Reservas</CardTitle></CardHeader>
            <CardContent>
          ...
          <Card className="shadow-elegant hover:shadow-gold transition-smooth cursor-pointer" onClick={() => navigate("/admin/users")}>
            <CardHeader><CardTitle>Gestionar Usuarios</CardTitle></CardHeader>
            <CardContent>
